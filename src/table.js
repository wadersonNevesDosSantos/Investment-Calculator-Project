...
export const createTable = (columnsArray, dataArray, tableId) => {
  if (
    ...
    throw new Error(
      "For the correct functionality, is needed an array with the columns, another with information of the rows and the id of  table element selected."
    );
  }
  const tableElement = document.getElementById(tableId);
  if (!tableElement || tableElement.nodeName !== "TABLE") {
    throw new Error(
      "Informed ID doesn't match with none of the table element."
    );
  }
